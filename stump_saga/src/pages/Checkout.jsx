...
const Checkout = () => {
  ...
  const submitHandler = (e) => {
    ...
    // Here you can dispatch an action to save the shipping address in the Redux store or perform any other required logic.
              ...
              <div className="checkout__bill">
                ...
                <div className="checkout__total">
                  <h5 className="d-flex align-items-center justify-content-between">
                    Total:{" "}
                    <span>₹{cartTotalAmount + shippingCost}</span>
                  </h5>
                </div>
              </div>
            </Col>
